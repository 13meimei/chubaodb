...
public:
    ...
    friend bool operator<(const RowResult &r1, const RowResult &r2) {
        ...
        if (r1.col_order_by_infos_ != nullptr && r2.col_order_by_infos_ != nullptr
            ...
            for (auto &colInfo : *(r1.col_order_by_infos_)) {
                ...
                if (fcompare(*(r1.GetField(colInfo.col_id)),
                    *(r2.GetField(colInfo.col_id)),
                    CompareOp::kEqual)) {
                    continue;
                }
                bCmp = fcompare(*(r1.GetField(colInfo.col_id)),
                    *(r2.GetField(colInfo.col_id)),
                    CompareOp::kLess);
    ...
    void SetColumnOrderByInfos(std::vector<ColumnOrderByInfo> &infos) { col_order_by_infos_ = &infos; }
...
private:
    ...
    std::vector<ColumnOrderByInfo> *col_order_by_infos_ = nullptr;
};
