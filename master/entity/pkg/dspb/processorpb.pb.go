...
const (
	...
	ProcessorType_STREAM_AGGREGATION_TYPE ProcessorType = 5
	ProcessorType_ORDER_BY_TYPE           ProcessorType = 6
	ProcessorType_LIMIT_TYPE              ProcessorType = 7
	ProcessorType_DATA_SAMPLE_TYPE        ProcessorType = 8
)
...
type Processor struct {
	...
	StreamAggregation    *Aggregation  `protobuf:"bytes,7,opt,name=stream_aggregation,json=streamAggregation,proto3" json:"stream_aggregation,omitempty"`
	Ordering             *Ordering     `protobuf:"bytes,8,opt,name=ordering,proto3" json:"ordering,omitempty"`
	Limit                *Limit        `protobuf:"bytes,9,opt,name=limit,proto3" json:"limit,omitempty"`
	DataSample           *DataSample   `protobuf:"bytes,10,opt,name=data_sample,json=dataSample,proto3" json:"data_sample,omitempty"`
...
var fileDescriptor_fae596f7f12da630 = []byte{
	...
	,
}
...
func (m *Processor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StreamAggregation != nil {
		{
			size, err := m.StreamAggregation.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Processor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StreamAggregation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.StreamAggregation == nil {
				m.StreamAggregation = &Aggregation{}
			}
			if err := m.StreamAggregation.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
